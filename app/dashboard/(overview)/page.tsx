...
// import { fetchRevenue, fetchLatestInvoices, fetchCardData } from '../../lib/data'; // Borrada
// import { fetchLatestInvoices, fetchCardData } from "../../lib/data"; // Borrado
...
export default async function Page() {
  // const revenue = await fetchRevenue(); // Borrada
  ...
  return (
    <main>
      ...
      <div className="mt-6 grid grid-cols-1 gap-6 md:grid-cols-4 lg:grid-cols-8">
        {/* <RevenueChart revenue={revenue} /> // Borrada*/}
